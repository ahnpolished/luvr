...
MAJOR_ARCANA: list[dict] = [
    ...
    {"number": 2, "slug": "high_priestess", "name": "The High Priestess", "meaning": "Intuition, the subconscious, mystery"},
    ...
    {"number": 5, "slug": "hierophant", "name": "The Hierophant", "meaning": "Tradition, spiritual wisdom, institutions"},
    {"number": 6, "slug": "lovers", "name": "The Lovers", "meaning": "Love, harmony, alignment of values"},
    {"number": 7, "slug": "chariot", "name": "The Chariot", "meaning": "Determination, willpower, overcoming obstacles"},
    ...
    {"number": 10, "slug": "wheel_of_fortune", "name": "Wheel of Fortune", "meaning": "Cycles, destiny, turning points"},
